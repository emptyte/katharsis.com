...
import {
  ...
  operatorNavigationConfig,
} from '@/common/constants/sidebar.constants';
import SidebarProfile from './sidebar-profile';
import { usePathname } from 'next/navigation';
import { useEffect, useState } from 'react';
import SidebarItem from './sidebar-item';
import { NavItem } from '@/common/types/nav-item.type';
...
function Sidebar({ role, user, currentBranch }: SidebarProps) {
  ...
  return (
    <aside className="h-screen w-72 bg-theme-obsidian flex flex-col border-r border-gray-100/10 transition-all duration-300">
      ...
      {/* 2. NAVIGATION BODY */}
      <nav className="flex-1 overflow-y-auto p-4 flex flex-col gap-6 scrollbar-hide">
